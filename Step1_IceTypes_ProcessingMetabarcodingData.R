...
# Date: 2023.05.29
# Primer pair: ill-1380F and ill-1510R for 18S V9 gene region 
# Sequencing completed by Sequench (https://www.sequench.co.nz/)
# Run numbers CAW-23-21
...
setwd("C:/Users/user/Documents/CAW-23-21") # Sequence files 1
...
source_folder <- "C:/Users/user/Documents/CAW-23-21/v9" # Sequence files
...
path <- "C:/Users/user/Documents/CAW-23-21/sequence-files"
list.files(path)
...
file_name_stop1 <- paste0("C:/Users/user/Documents/CAW-23-21/workspace_environments/",current_datetime,"_CAW-23-21_stop1", ".RData")
...
load("C:/Users/user/Documents/CAW-23-21/workspace_environments/2023-05-29_14-38_CAW-23-21_stop1.RData")
...
file_name_stop2 <- paste0("C:/Users/user/Documents/CAW-23-21/workspace_environments/",current_datetime,"_CAW-23-21_stop2", ".RData")
...
### CHANGE ME ###
# Make sure you update this file link as you save out your stop point files.
load("C:/Users/user/Documents/CAW-23-21/workspace_environments/2023-05-29_15-28_CAW-23-21_stop2")
...
#generate dynamic file name to track iterations
current_datetime <- format(Sys.time(), "%Y-%m-%d_%H-%M")
file_name_stop3 <- paste0("C:/Users/user/Documents/CAW-23-21/workspace_environments/",current_datetime,"_CAW-23-21_stop3", ".RData")
...
### CHANGE ME ###
# Make sure you update this file link as you save out your stop point files.
load("C:/Users/user/Documents/CAW-23-21/workspace_environments/2023-05-29_17-51_CAW-23-21_stop3.RData")
...
#generate dynamic file name to track iterations
current_datetime <- format(Sys.time(), "%Y-%m-%d_%H-%M")
file_name_stop3_checkpoint <- paste0("C:/Users/user/Documents/CAW-23-21/workspace_environments/",current_datetime,"_CAW-23-21_stop3-checkpoint", ".RData")
...
saveRDS(seqtab.nochim, "C:/Users/user/Documents/CAW-23-21/CAW-23-21_jacqui_v9_seqtab.nochim.rds")
...
#generate dynamic file name to track iterations
current_datetime <- format(Sys.time(), "%Y-%m-%d_%H-%M")
file_name_stop4 <- paste0("C:/Users/user/Documents/CAW-23-21/workspace_environments/",current_datetime,"_CAW-23-21_stop4", ".RData")
...
seqtab.nochim.CAW.23.21 <- readRDS("C:/Users/user/Documents/R/CAW-23-21_v9_seqtab.nochim.rds")
...
saveRDS(v9.seqtab.merge, "C:/Users/user/Documents/R/2023-06-01_v9_merged-seqtab.nochim.rds")
...
v9.seqtab.merge <- readRDS("C:/Users/user/Documents/R/2023-06-01_v9_merged-seqtab.nochim.rds")
...
#------------------------------------------------------------------------------------------------------------------------------------------------#
# track rejected reads at each step
